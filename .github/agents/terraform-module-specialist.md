...
**Module References:**
- Use `source` with explicit versions for external modules
- Use `module.label.context` to pass context to nested modules
...
## 🚨 Terraform Module Safety Checklist
